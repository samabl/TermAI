...
| ADR-0031 | 渲染字体栈的 unmaintained 阻塞：rustybuzz / ttf-parser | **Proposed** | AR-01、AR-03、AR-18、AR-21、DC-17、DC-21 | ADR-0027 D3 采证发现 `advisories` 失败：`rustybuzz` RUSTSEC-2026-0206、`ttf-parser` RUSTSEC-2026-0192，均 unmaintained 且无安全升级，而 DC-17/K-05 指定 `rustybuzz` 为唯一 shaping 引擎。给出「时间盒例外（需到期 + 替换触发 + SBOM 标注）」与「立刻替换（改 DC-17/K-05）」两条路及其代价；**因属安全默认值放宽，状态 Proposed，决定权在 owner/TSC** |
