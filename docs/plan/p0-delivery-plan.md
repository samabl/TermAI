...
12. **改数字必须同时改总表；更正时给旧结论加删除线**（第 98、128、147、148、151 轮）：**本会话七处「文档与现实不一致」没有一处是写错，全是「只改了一半」**——追加更正会把旧断言留在行首。**做法**：**旧结论加删除线并注明轮次，新结论随后**；摘要与细节在同一次改动里一起改。
