...
>
> **方法纪律**：[docs/plan/p0-delivery-plan.md](../plan/p0-delivery-plan.md) §6.3（**二十一条**）。其中**十一条（第 10–20 条）**由本会话的失败直接换来：**先取状态再谈语义**、**协议层优先于套件**、**验证与提交分离**、**改数字必须同时改总表**。
>
